...
public class TCS3200_ColorReader implements Sendable {
  ...
  public TCS3200_ColorReader(int out, int s0, int s1, int s2, int s3, ColorSelect startColor, FreqScaling startFreq) {
  ...
  public void initSendable(SendableBuilder builder) {
    builder.setSmartDashboardType("TCS3200 Color Reader");
